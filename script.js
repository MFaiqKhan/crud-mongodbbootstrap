...
let users;
function getPost() {
    axios.get('https://crud-express-mongodb-basic.herokuapp.com/users').then(responce => {
...
function updateUser(id) {
    ...
    axios.put(`https://crud-express-mongodb-basic.herokuapp.com/user/${id}`, {
        name,
        email,
        address
    }).then(() => {
...
function deleteUser(id) {
    ...
    axios.delete(`https://crud-express-mongodb-basic.herokuapp.com/user/${id}`).then((e) => {
        // getPost()
        document.getElementById('alertcontainer').innerHTML = `<div class="alert alert-success" role="alert">
            User Are Deleted!!!
            </div>`
